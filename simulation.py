...
if __name__ == "__main__":
    ...
    print(
        f"average number of guesses without knowing answer list: {simulation(word_list, answer_list)}"
    )
    print(
        f"average number of guesses given answer list: {simulation(answer_list, answer_list)}"
    )
